...
const Features = () => {
  ...
  return (
    <div className="relative px-4 sm:px-6 py-8 sm:py-12 min-h-[100vh]">
      ...
      <div className="absolute lg:-top-14 top-20 left-0 right-0 bottom-0 bg-[url('/src/assets/img/featuresBg.png')] bg-no-repeat bg-cover h-[105vh] w-full -z-10"></div>
      <div className="absolute -top-6 left-0 h-[271px] w-full bg-black/95 blur-2xl -z-10"></div>
      <div className="min-[1400px]:max-w-[90%] max-w-[94%] mx-auto grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-3 lg:mt-28 md:mt-16 mt-4">
          ...
          <div key={index} className="relative overflow-hidden">
            <div className="bg-featureCard min-h-[340px] rounded-sm flex flex-col gap-8 py-6 px-6 group hover:bg-hoverfeature transition-colors duration-300 ">
              ...
              <div className="flex flex-col">
                <h3 className="font-outfit text-white text-2xl">
                  {feature.firstTitle}
                </h3>
                <h3 className="font-outfit text-heroColor text-2xl">
                  {feature.secondTitle}
                </h3>
              </div>
