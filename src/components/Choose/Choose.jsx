...
import { chooseImg2 } from "../../assets/img/images";
...
const Choose = () => {
  ...
  return (
    <div className="relative px-4 sm:px-6 py-8 lg:py-6 xl:py-10 min-[1400px]:py-0 xl:h-[100vh]">
        ...
        <div className="flex flex-col md:gap-10 gap-6">
          <div className="max-w-3xl mx-auto">
            <h3 className="font-outfit-bold text-[26px] min-[540px]:text-3xl sm:text-4xl md:text-5xl  leading-tight text-white text-center font-medium">
              Why Choose <span className="text-heroColor ">CollabDash?</span>{" "}
            </h3>
          </div>
          ...
          <div className="flex md:gap-4 gap-2 items-center lg:flex-row flex-col flex-wrap justify-center md:max-w-7xl md:mx-auto">
            {choose.map((item, index) => (
              ...
              >
                ...
                <div>
                  <p className="font-outfit xl:text-lg md:text-base min-[540px]:text-base text-base text-white md:text-start text-center">
                    {item}
                  </p>
                </div>
              </div>
          ...
          <div className="min-[1400px]:mt-8 min-[540px]:w-auto w-[330px] mx-auto">
            <img
              src={chooseImg2}
              alt=""
      ...
      <div className="absolute -bottom-20 left-0 min-[1400px]:h-[240px] xl:h-[200px] lg:h-[100px] h-[100px] w-full bg-black/100 blur-2xl -z-10"></div>
    </div>
  );
};
